...
class BIP66Test(LoodTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # loodd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and loodd produces more specific reject
            # reasons.
