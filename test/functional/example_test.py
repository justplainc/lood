...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the LoodTestFramework
    pass

class ExampleTest(LoodTestFramework):
    # Each functional test is a subclass of the LoodTestFramework class.
    ...
    def custom_method(self):
        ...
        LoodTestFramework class so other tests can use it."""
