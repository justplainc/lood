...
# TestNode: A peer we use to send messages to loodd, and store responses.
...
class CompactBlocksTest(LoodTestFramework):
    ...
    # This test actually causes loodd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that loodd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for loodd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # loodd will not send blocktxn responses for blocks whose height is
