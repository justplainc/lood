Lood Core version 0.9.4 is now available from:

  https://lood.org/bin/0.9.4/
...
this update is incompatible with the Lood system and could lead to consensus
forks.

Lood Core released binaries from https://lood.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~lood/+archive/ubuntu/lood
- A third-party or self-compiled Lood Core

upgrade to Lood Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
