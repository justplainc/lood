Lood Core version 0.10.4 is now available from:

  <https://lood.org/bin/lood-core-0.10.4/>
...
- #6953 `43c2789` Split lood-tx into its own package
- #6953 `dfe0d4d` Include lood-tx binary on Debian/Ubuntu
