Lood Core version 0.9.2.1 is now available from:

  https://lood.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 LOOD to 0.01 LOOD
...
- Fix "Start lood on system login"
