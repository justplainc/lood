Lood-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/lood/files/Lood/lood-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Lood
...
New/changed settings (command-line or lood.conf file)
--------------------------------------------------------
