Lood version 0.5.4 is now available for download at:
http://sourceforge.net/projects/lood/files/Lood/lood-0.5.4/
...
http://gitorious.org/lood/loodd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Lood-Qt notifications under Growl 1.3.
Increase required age of Lood-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxLood properly when installing Lood-Qt over it. (Windows)
