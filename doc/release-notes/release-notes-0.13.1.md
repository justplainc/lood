Lood Core version 0.13.1 is now available from:

  <https://lood.org/bin/lood-core-0.13.1/>
...
To receive security and update notifications, please subscribe to:
  ...
  <https://loodcore.org/en/list/announcements/join/>
...
- **Script versioning:** Segwit makes it easy for future soft forks to allow
  ...
  currently being researched by Lood Core contributors that may use this
...
[versionbits FAQ]: https://loodcore.org/en/2016/06/08/version-bits-miners-faq/
...
- #8848 `7a34a46` Add NULLDUMMY verify flag in loodconsensus.h (jl2012)
...
- #8940 `5b4192b` Add x9 service bit support to dnsseed.bluematt.me, seed.loodstats.com (TheBlueMatt, cdecker)
- #8944 `685e4c7` Remove bogus assert on number of oubound connections. (TheBlueMatt)
- #8949 `0dbc48a` Be more agressive in getting connections to peers with relevant services (gmaxwell)

### Build system
- #8293 `fa5b249` Allow building libloodconsensus without any univalue (luke-jr)
- #8492 `8b0bdd3` Allow building bench_lood by itself (luke-jr)
...
- #8829 `2a8bca4` Add lood-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` lood-util-test.py should fail if the output file is empty (jnewbery)
...
- #8860 `0bee740` util: Move wait_loodds() into stop_nodes() (MarcoFalke)
...
- #8683 `8a7d7ff` Fix incorrect file name lood.qrc  (loodsSG)
...
- #8817 `bcf3806` update lood-tx to output witness data (jnewbery)
