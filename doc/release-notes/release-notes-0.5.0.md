Lood version 0.5.0 is now available for download at:
http://sourceforge.net/projects/lood/files/Lood/lood-0.5.0/
...
For Ubuntu users, there is a new ppa maintained by Matt Corallo which you can add to your system so that it will automatically keep lood up-to-date.  Just type "sudo apt-add-repository ppa:lood/lood" in your terminal, then install the lood-qt package.
...
If you have a previously encrypted wallet.dat, the first time you run lood-qt or loodd the wallet will be rewritten, Lood will
...
Lood-Qt: Address Book, then New Address...
...
Drag and drop support for lood: URIs on web pages.
...
signmessage/verifymessage : new RPC commands to sign a message with one of your private keys or verify that a message signed by the private key associated with a lood address.
