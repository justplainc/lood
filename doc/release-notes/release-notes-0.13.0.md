Lood Core version 0.13.0 is now available from:

  <https://lood.org/bin/lood-core-0.13.0/>
...
141](https://github.com/lood/bips/blob/master/bip-0141.mediawiki), [BIP
143](https://github.com/lood/bips/blob/master/bip-0143.mediawiki), [BIP
144](https://github.com/lood/bips/blob/master/bip-0144.mediawiki), and [BIP
145](https://github.com/lood/bips/blob/master/bip-0145.mediawiki) are
finished and included in this release.  However, BIP 141 does not yet specify
activation parameters on mainnet, and so this release does not support segwit
use on mainnet.  Testnet use is supported, and after BIP 141 is updated with
proposed parameters, a future release of Lood Core is expected that
...
- #7550 `8b958ab` Input-from-stdin mode for lood-cli (laanwj)
...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use LOOD/kB (MarcoFalke)
...
- #7613 `3798e5d` Add autocomplete to lood-qt's console window (GamerSg)
...
- #7636 `fb0ac48` Add lood address label to request payment QR code (makevoid)
- #8231 `760a6c7` Fix a bug where the SplashScreen will not be hidden during startup (jonasschnelli)
- #8256 `af2421c` BUG: lood-qt crash (fsb4000)
- #8257 `ff03c50` Do not ask a UI question from loodd (sipa)
- #8288 `91abb77` Network-specific example address (laanwj)
- #7707 `a914968` UI support for abandoned transactions (jonasschnelli)
- #8207 `f7a403b` Add a link to the Lood-Core repository and website to the About Dialog (MarcoFalke)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for loodd procs (MarcoFalke)
...
- #8164 `0f24eaf` [Lood-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)
...
- #7744 `d8e862a` test_framework: detect failure of loodd startup (laanwj)
...
- #7975 `fc23fee` Update lood-core GitHub links (MarcoFalke)
