Lood Core version 0.14.2 is now available from:

  <https://download.lood.org/lood-0.14.2.0/>
...
Lood Core now supports P2SH addresses beginning with M on mainnet and Q on testnet.
...
This only affects users that have explicitly enabled UPnP through the GUI setting or through the -upnp option, as since the last UPnP vulnerability (in Lood Core 0.10.4) it has been disabled by default.
...
- http://testnet.loodtools.com
- http://testnet.thrasher.io

Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/lood-project/lood/blob/master/src/chainparams.cpp#L220).
...
Lood Core has supported automatically pruning the blockchain since 0.13.2. Pruning
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/lood-project/lood/blob/master/doc/zmq.md) for
...
The Alert System was disabled and deprecated in Lood Core 0.10.4 and removed in 0.13.2. 
...
here, originally written for Lood but can also be used for Lood:
[reducing-loodd-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
