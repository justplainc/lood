...
This document provides guidelines for internationalization of the Lood Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `lood_en.ts` remains unchanged.
