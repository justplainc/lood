...
#if defined(NDEBUG)
# error "Lood cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Lood Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s LOOD additional fees, %d delta bytes\n",
