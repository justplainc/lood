...
/** Lood unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class LoodUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LoodUnits(QObject *parent);

    /** Lood units.
      @note Source: https://en.lood.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        LOOD,
...
typedef LoodUnits::Unit LoodUnit;
