 ...
 * between loodd, and lood-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/lood-project/lood>";
    const std::string URL_WEBSITE = "<https://lood.org>";
...
/** Sanity checks
 *  Ensure that Lood is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Lood process is using the data directory.
