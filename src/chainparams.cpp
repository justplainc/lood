...
//Copyright (c) 2015-2022 The Lood Company
...
{
    const char* pszTimestamp = "France24 29/Aug/2021 Crypto money gains traction in adult industry amid OnlyFans drama";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1644098591, 2059837, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x22334faf9b112aca5b7057790180779c284413f2325ab61166cc7e58252d02f5"));
        assert(genesis.hashMerkleRoot == uint256S("0x5570eeb757678af694e9ff87539d6b1201ba4d72e9203ea957decef1a0c3c4bb"));

        vSeeds.emplace_back("seed.lood.cash", true);
        
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,48);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,5);
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(1,50);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,48);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x45, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x45, 0x88, 0xAD, 0xE4};
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x22334faf9b112aca5b7057790180779c284413f2325ab61166cc7e58252d02f5")},
                /*
        ...
        chainTxData = ChainTxData{
            ...
            1644098591, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.loodtools.com", true);
        vSeeds.emplace_back("seed-b.lood.loshan.co.uk", true);
