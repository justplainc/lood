...
unlocked to sign the Lood-Qt.app bundle.
...
allowing somebody to distribute a Lood-Qt.app or lood-qt-setup.exe with a valid
...
that the lood-qt.exe file inside the installer had not been tampered with.
